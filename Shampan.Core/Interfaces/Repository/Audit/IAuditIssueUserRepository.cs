...
namespace Shampan.Core.Interfaces.Repository.Audit
{
    public interface IAuditIssueUserRepository : IBaseRepository<AuditIssueUser>
    {
        ...
        AuditIssueUser AudiIssueUserUpdateById(AuditIssueUser model);
        List<AuditIssueUser> GetAuditIssueUserById(string[] conditionalFields, string[] conditionalValue, PeramModel vm = null);
