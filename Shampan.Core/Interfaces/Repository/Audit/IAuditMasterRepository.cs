...
namespace Shampan.Core.Interfaces.Repository.Audit
{
    ...
    {
        bool CheckIssueStatus(string tableName, string[] conditionalFields, string[] conditionalValue);
        bool CheckListItemsStatus(string tableName, string[] conditionalFields, string[] conditionalValue);
		...
		int AuditNotificationUpdate(string notification,int? id);
       ...
       int AuditResponseGetIndexDataCount(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null);  
        ...
        AuditMaster BranchFeedbackCompleted(AuditMaster model);
        ...
        BKAuditTemplateDetails AuditTemplateDetails (BKAuditTemplateDetails model);
