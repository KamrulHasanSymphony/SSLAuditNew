...
namespace Shampan.Core.Interfaces.Repository.AuditFeedbackRepo
{
    public interface IAuditBranchFeedbackRepository : IBaseRepository<AuditBranchFeedback>
    {
        ...
        AuditBranchFeedback IssueUpdate(AuditBranchFeedback model);
        List<AuditBranchFeedback> GetIndexDataFeedbackPreview(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null);
