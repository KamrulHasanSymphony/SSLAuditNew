...
namespace Shampan.Services.Audit
{
    public class AuditIssueUserService : IAuditIssueUserService
    {
        ...
        public List<AuditIssueUser> GetAuditIssueUsersList(string userId, int? id)
        {
            ...
            {
                string stringValue = id.ToString();
                List<AuditIssueUser> master = context.Repositories.AuditIssueUserRepository.GetAuditIssueUsersList(userId,id);
                context.SaveChanges();
                return master;
        ...
        public ResultModel<AuditIssueUser> AudiIssueUserUpdateById(AuditIssueUser model)
        {
            using IUnitOfWorkAdapter context = _unitOfWork.Create();
            try
            {
                AuditIssueUser master = context.Repositories.AuditIssueUserRepository.AudiIssueUserUpdateById(model);
        ...
        public ResultModel<List<AuditIssueUser>> GetAuditIssueUserById(string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            using IUnitOfWorkAdapter context = _unitOfWork.Create();
            try
            {
                List<AuditIssueUser> master = context.Repositories.AuditIssueUserRepository.GetAuditIssueUserById(conditionalFields,conditionalValue,vm);
