...
namespace Shampan.Services.Audit
{
    public class AuditAreasService : IAuditAreasService
    {
        ...
        public ResultModel<List<AuditAreas>> GDIC_GetIndexData(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            using IUnitOfWorkAdapter context = _unitOfWork.Create();
            try
            {
                List<AuditAreas> records = context.Repositories.AuditAreasRepository.GDIC_GetIndexData(index, conditionalFields, conditionalValue);
                context.SaveChanges();
        ...
        public ResultModel<int> GDIC_GetIndexDataCount(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            using IUnitOfWorkAdapter context = _unitOfWork.Create();
            try
            {
                int records = context.Repositories.AuditAreasRepository.GDIC_GetIndexDataCount(index, conditionalFields, conditionalValue);
                context.SaveChanges();
        ...
        public int GDIC_GetCount(string tableName, string fieldName, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            using IUnitOfWorkAdapter context = _unitOfWork.Create();
            try
            {
