...
namespace Shampan.Services.CompanyInfo
{
    public class CompanyInfoService: ICompanyInfoService
    {
        ...
        public string[] CheckADAuth(string UserName, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null, Models.CompanyInfo companyInfo = null)
        {
            ...
            try
            {
                retResults = context.Repositories.CompanyInfoRepository.CheckADAuth(UserName, conditionalFields, conditionalValue,null, companyInfo);
