...
namespace Shampan.Services.AuditIssues
{
    public class AuditIssuesService : IAuditIssueService
    {
        ...
        public ResultModel<AuditIssue> DeActiveIssue(AuditIssue model)
        {
            using (var context = _unitOfWork.Create())
            {
                try
                {
                    AuditIssue master = context.Repositories.AuditIssueRepository.DeActiveIssue(model);
                    context.SaveChanges();
        ...
        public ResultModel<AuditIssue> ActiveIssue(AuditIssue model)
        {
            using (var context = _unitOfWork.Create())
            {
                try
                {
                    AuditIssue master = context.Repositories.AuditIssueRepository.ActiveIssue(model);
                    context.SaveChanges();

                    return new ResultModel<AuditIssue>()
                    {
                        Status = Status.Success,
                        Message = MessageModel.ActivateSuccess,
                        Data = model
                    };
        ...
        public ResultModel<DataTable> DetailsInformation(ReportModel model)
        {
            using (var context = _unitOfWork.Create())
            {
                ...
                try
                {
                    DataTable records = context.Repositories.AuditIssueRepository.DetailsInformation(model);
