...
namespace Shampan.Services.AuditFeedbackService
{
    public class AuditBranchFeedbackService : IAuditBranchFeedbackService
    {
        ...
        public ResultModel<AuditBranchFeedback> Insert(AuditBranchFeedback model)
        {
            ...
            try
            {
                ...
                if(master.Id > 0)
                {
                    ...
                    var item = context.Repositories.AuditBranchFeedbackRepository.IssueUpdate(model);
        ...
        public ResultModel<List<AuditBranchFeedback>> GetIndexDataFeedbackPreview(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            using IUnitOfWorkAdapter context = _unitOfWork.Create();
            try
            {
                List<AuditBranchFeedback> records = context.Repositories.AuditBranchFeedbackRepository.GetIndexDataFeedbackPreview(index, conditionalFields, conditionalValue);
                context.SaveChanges();
