...
namespace Shampan.Services.Company
{
    public class CompanyInfosService : ICompanyInfosService
    {
        ...
        //public string[] CheckADAuth(string UserName, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null, Models.Companyinfos companyInfo = null)
        //{
        ...
        //    try
        //    {
        //        retResults = context.Repositories.CompanyInfosRepository.CheckADAuth(UserName, conditionalFields, conditionalValue, null, companyInfo);
