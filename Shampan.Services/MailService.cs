...
namespace Shampan.Services
{
        ...
        public static bool SendFeedbackReviewedlMail(string to, string Approvurl, string AuditName)
        {
            string subject = "SendFeedbackReviewedlMail"; string mailBody; string url = Approvurl; string userFullName = "Sir"; Attachment pdfLink;
            var sent = false;
                          ...
                          "<tr> " +
                                "<td style = 'text-align:left;'>" +
                                    "<div style = 'margin-left:10px;color:black;'> " +
                                            ...
                                            "<div style='margin:0px 0 0px 0'><font size = '2' ><span style='font-size:10pt'> Hello! </span></font></div>" + "<div> &nbsp;</div> " +
                                            "<div style='margin:0px 0 0px 0'><font size = '2' ><span style='font-size:10pt'> We hope this email finds you well. </span></font></div>" + "<div> &nbsp;</div> " +
                                            "<div><font face = 'Calibri' size = '2'><span style = 'font-size:10pt'>The audit issue  -<b>" + AuditName + "</b> has been reviewed and change request has been provided.  </span></font></div>" + "<div> &nbsp;</div> " +
            ...
            sent = SendFeedbackReviewedlMailToTeam(to, bodyString, message);
                                ...
                                "<td style = 'text-align:left;'>" +
                                    ...
                                    "<div style='margin:0px 0 0px 0'><font size = '2' ><span style='font-size:10pt'> Hello! </span></font></div>" +
                                           "<div> &nbsp;</div> " +
                                            ...
                                            "<div style='margin:0px 0 0px 0'><font size = '2' ><span style='font-size:10pt'> We trust this message finds you well.  </span></font></div>" +
                                             "<div> &nbsp;</div> " +
                                            "<div><font face = 'Calibri' size = '2'><span style = 'font-size:10pt'>We are pleased to inform you that the <b style='color:blue'> Final Audit Report </b> - <b>" + AuditName + "</b> has been concluded, requesting to click on the below link to view the report.</span></font></div>" +                                             
                                             "<div> &nbsp;</div> " +
