...
namespace Shampan.Services
{
    public class CommonService : ICommonService
    {
        ...
        public List<CommonDropDown>? GetBranchFeedbackIssues(string auditId, string userName, AuditMaster master)
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.GetBranchFeedbackIssues(auditId, userName, master).Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? CheckListItem(int auditId=0)
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.CheckListItem(auditId).Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? AuditAreaType(int auditIssueLevel = 0,string level="0")
        {
            List<CommonDropDown> records = new List<CommonDropDown>();
            using var context = _unitOfWork.Create();
            try
            {
                records = context.Repositories.CommonRepository.AuditAreaType(auditIssueLevel,level).Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? AuditPointType(int pId = 0)
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.AuditPointType(pId).Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? AuditTemplate()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.AuditTemplate().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? BkCheckListTypes()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.BkCheckListTypes().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? BkCheckListSubTypes()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.BkCheckListSubTypes().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? BKAuidtCategorys()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.BKAuidtCategorys().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? BKAuditOfficeTypes()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.BKAuditOfficeTypes().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? BKAuditOffice()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.BKAuditOffice().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? BkAuditCompliances()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.BkAuditCompliances().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? GetAreaAuditTypes()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.GetAreaAuditTypes().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? FieldType()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.FieldType().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
        ...
        public List<CommonDropDown>? GetRiskType()
        {
            ...
            try
            {
                records = context.Repositories.CommonRepository.GetRiskType().Select(c => new CommonDropDown
                {
                    Name = c.Name,
                    Value = c.Value
                }).ToList();
