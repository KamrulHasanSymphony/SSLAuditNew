...
public class AuditMaster
{
    ...
    public AuditApprove auditApprove { set; get; }

    public List<BKAuditTemplateDetails> BKAuditTemplateDetails { set; get; }

    public List<AuditUser> AuditUsers { set; get; }
    ...
    public AuditMaster()
    {
        ...
        auditApprove = new AuditApprove();
        BKAuditTemplateDetails = new List<BKAuditTemplateDetails>();
        AuditUsers = new List<AuditUser>();
    }
