...
public class MessageModel
{
    ...
    public static string MailSuccess { get; set; } = "Email has been sent successfully";
    ...
    public static string ActivateSuccess { get; set; } = "Data Activate Successfully";
    ...
    public static string TeamMessages { get; set; } = "You have to assign team member first for team";
    public static string TeamUser { get; set; } = "This is a team you can not insert same user";
    ...
    public static string FiscalYearStatusAlready { get; set; } = "Fiscal Year Is Already Saved";
    public static string IssueAlready { get; set; } = "Issue has been created Already";
    public static string ListItemsNotComplete { get; set; } = "List Items is not completed in Audit Issue create part";
...
public class TableName
{
    ...
    public static string AuditPoints { get; set; } = "AuditPoints";
    ...
    public static string BKAuditTemplateDetails { get; set; } = "BKAuditTemplateDetails";
    public static string AuditTemplateDetails { get; set; } = "AuditTemplateDetails";
    ...
    public static string BKAuditTemlateMaster { get; set; } = "BKAuditTemlateMaster";
    ...
    public static string BKCheckListItems { get; set; } = "BKCheckListItems";
    public static string BKCheckListSubTypes { get; set; } = "BKCheckListSubTypes";
    public static string BKAuditCompliance { get; set; } = "BKAuditCompliances";
    public static string BKCheckListTypes { get; set; } = "BKCheckListTypes";
    public static string BKRiskAssessPerferenceSettings { get; set; } = "BKRiskAssessPerferenceSettings";
    public static string BKFinancePreformPreferenceCBS { get; set; } = "BKFinancePreformPreferenceCBS";
    public static string BKRiskAssessRegulationPreferenceCBS { get; set; } = "BKRiskAssessRegulationPreferenceCBS";
    public static string BKFraudIrregularitiesInternalControlPreferenceCBS { get; set; } = "BKFraudIrregularitiesInternalControlPreferenceCBS";
    public static string FiscalYears { get; set; } = "FiscalYears";
    public static string BKAuditInfoMaster { get; set; } = "BKAuditInfoMaster";
    public static string BKAuditInfoMasterApproval { get; set; } = "BKAuditInfoMasterApproval";
    public static string BKAuditInfoDetails { get; set; } = "BKAuditInfoDetails";
    public static string BKCommonSelectionSettings { get; set; } = "BKCommonSelectionSettings";
    public static string BKAuditPreferenceEvaluations { get; set; } = "BKAuditPreferenceEvaluations";
    public static string BKReguCompliancesPreferenceSettings { get; set; } = "BKReguCompliancesPreferenceSettings";
    public static string BKFinancePerformPreferenceSettings { get; set; } = "BKFinancePerformPreferenceSettings";
    public static string BKAuditOfficeTypes { get; set; } = "BKAuditOfficeTypes";
    public static string Category { get; set; } = "bk_audit_categories";
    ...
    public static string DeskboardSetting { get; set; } = "DeskboardSetting";
