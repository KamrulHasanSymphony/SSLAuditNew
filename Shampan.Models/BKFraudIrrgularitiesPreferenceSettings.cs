...
{
    public class BKFraudIrrgularitiesPreferenceSettings
    {
        ...
        [Display(Name = "Previously Fraud IncidentFlag")]
        public bool PreviouslyFraudIncidentFlag { set; get; }
        [Display(Name = "EmpMis ConductFlag")]
        public bool EmpMisConductFlag { set; get; }       
        ...
        public BKFraudIrrgularitiesPreferenceSettings()
        {
            Audit = new Audit();
        }
    }
