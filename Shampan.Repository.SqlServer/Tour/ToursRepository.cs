...
,@CreatedFrom
				...
				command.Parameters.Add("@Name", SqlDbType.NChar).Value = string.IsNullOrEmpty(model.Name) ? (object)DBNull.Value : model.Name;
				command.Parameters.Add("@EmpName", SqlDbType.NChar).Value = model.EmpName;
				command.Parameters.Add("@EmployeeId", SqlDbType.NChar).Value = model.EmployeeId;
...
left join {AuthDbConfig.AuthDB}.[dbo].[AspNetUsers] u on tm.UserId = u.Id
...
where 1=1";
        ...
        public SalesInvoice SaleInsert(SalesInvoice model)
        {
            ...
            try
            {
                ...
                var command = CreateCommand(@" INSERT INTO SalesInvoices(
...
,@SubTotal
                ...
                command.Parameters.Add("@SalesInvoiceNo", SqlDbType.NVarChar).Value = model.SalesInvoiceNo;
                command.Parameters.Add("@BranchCode", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(model.BranchCode) ? (object)DBNull.Value : model.BranchCode;
                command.Parameters.Add("@BranchName", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(model.BranchName) ? (object)DBNull.Value : model.BranchName;
                command.Parameters.Add("@CustomerCode", SqlDbType.NVarChar).Value = model.CustomerCode;
                command.Parameters.Add("@CustomerName", SqlDbType.NVarChar).Value = model.CustomerName;
                command.Parameters.Add("@InvoiceDateTime", SqlDbType.DateTime).Value = model.InvoiceDateTime;
                ...
                command.Parameters.Add("@NBRPrice", SqlDbType.Decimal).Value = model.NBRPrice;
        ...
        public List<SalesInvoice> GetSaleIndexData(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            string sqlText = "";
            List<SalesInvoice> VMs = new List<SalesInvoice>();
            DataTable dt = new DataTable();
...
";
                ...
                objComm.Fill(dt);
                var req = new SalesInvoice();

                VMs.Add(req);


                VMs = dt.ToList<SalesInvoice>();
        ...
        public int GetSaleIndexDataCount(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            string sqlText = "";
            List<Tours> VMs = new List<Tours>();
            DataTable dt = new DataTable();
        ...
        public PurchaseInvoice PurchaseInsert(PurchaseInvoice model)
        {
            try
            {
                string sqlText = "";

                var command = CreateCommand(@" INSERT INTO PurchaseInvoices(
...
,@VATAmount
                ...
                command.Parameters.Add("@PurchaseInvoiceNo", SqlDbType.NVarChar).Value = model.PurchaseInvoiceNo;
                command.Parameters.Add("@BranchCode", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(model.BranchCode) ? (object)DBNull.Value : model.BranchCode;
                command.Parameters.Add("@BranchName", SqlDbType.NVarChar).Value = string.IsNullOrEmpty(model.BranchName) ? (object)DBNull.Value : model.BranchName;
                ...
                command.Parameters.Add("@ProductCode", SqlDbType.NVarChar).Value = model.ProductCode;
                command.Parameters.Add("@ProductName", SqlDbType.NVarChar).Value = model.ProductName;
                command.Parameters.Add("@BENumber", SqlDbType.NVarChar).Value = model.BENumber;
                command.Parameters.Add("@CostPrice", SqlDbType.Decimal).Value = model.CostPrice;
                command.Parameters.Add("@SDAmount", SqlDbType.Decimal).Value = model.SDAmount;
                command.Parameters.Add("@VATAmount", SqlDbType.Decimal).Value = model.VATAmount;
        ...
        public List<PurchaseInvoice> GetPurchasseIndexData(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            string sqlText = "";
            List<PurchaseInvoice> VMs = new List<PurchaseInvoice>();
            DataTable dt = new DataTable();
...
";
                ...
                objComm.Fill(dt);
                var req = new PurchaseInvoice();

                VMs.Add(req);


                VMs = dt.ToList<PurchaseInvoice>();
        ...
        public int GetPurchaseIndexDataCount(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            string sqlText = "";
            List<Tours> VMs = new List<Tours>();
            DataTable dt = new DataTable();
