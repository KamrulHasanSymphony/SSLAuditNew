...
namespace Shampan.Repository.SqlServer.BKAuditInfoMasterApprovalApprovals
{
	public class BKAuditInfoMasterApprovalRepository : Repository, IBKAuditInfoMasterApprovalRepository
    {
        private DbConfig _dbConfig;
        private SqlConnection context;
        private SqlTransaction transaction;       
        public BKAuditInfoMasterApprovalRepository(SqlConnection context, SqlTransaction transaction, DbConfig dbConfig)
        ...
        public List<BKAuditInfoMasterApproval> GetAll(string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
		{
            try
            {
...
,Code
,BKAuditOfficeTypeId
,ISNULL(BKAuditInfoMasterId,0)BKAuditInfoMasterId
,Date
,AuditApprovalFlag
,ApprovalAuthorityDesc
,Status
...
FROM  BKAuditInfoMasterApproval
...
where 1=1";
                ...
                List<BKAuditInfoMasterApproval> vms = dtResult.ToList<BKAuditInfoMasterApproval>();
                return vms;
		...
		{
            string sqlText = "";
            List<BKAuditInfoMasterApproval> VMs = new List<BKAuditInfoMasterApproval>();
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                select count(BKAuditInfoMasterApproval.Id)FilteredCount
                from BKAuditInfoMasterApproval  where 1=1 ";
        ...
        public List<BKAuditInfoMasterApproval> GetIndexData(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
		{
            string sqlText = "";
            List<BKAuditInfoMasterApproval> VMs = new List<BKAuditInfoMasterApproval>();
            DataTable dt = new DataTable();
...
";
                ...
                objComm.Fill(dt);
                var req = new BKAuditInfoMasterApproval();

                VMs.Add(req);


                VMs = dt.ToList<BKAuditInfoMasterApproval>();
		...
		public BKAuditInfoMasterApproval Insert(BKAuditInfoMasterApproval model)
		{
			try
			{
				string sqlText = "";

				var command = CreateCommand(@" INSERT INTO BKAuditInfoMasterApproval(
...
,@CreatedFrom
				...
				command.Parameters.Add("@AuditApprovalFlag", SqlDbType.Bit).Value = model.AuditApprovalFlag;
				command.Parameters.Add("@ApprovalAuthorityDesc", SqlDbType.NVarChar).Value = model.ApprovalAuthorityDesc;
        ...
        public BKAuditInfoMasterApproval MultiplePost(BKAuditInfoMasterApproval objBKAuditInfoMasterApproval)
        {
            try
            {
                string sqlText = "";
                ...
                string query = @"  update BKAuditInfoMasterApproval set 
    ...
    ,IsRejected=@IsRejected 
     ...
     where  Id= @Id ";
                ...
                return objBKAuditInfoMasterApproval;
		...
		public BKAuditInfoMasterApproval MultipleUnPost(BKAuditInfoMasterApproval vm)
		{

            return new BKAuditInfoMasterApproval();
		
		}

		public BKAuditInfoMasterApproval Update(BKAuditInfoMasterApproval model)
		{
			try
			{
				string sqlText = "";
...
,Date                               =@Date  
,AuditApprovalFlag                  =@AuditApprovalFlag  
,ApprovalAuthorityDesc              =@ApprovalAuthorityDesc  
,Status                             =@Status  
