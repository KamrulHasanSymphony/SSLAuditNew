...
";
      ...
      ,ASN.ProfileName
       ...
       left outer join {AuthDbConfig.AuthDB}.[dbo].[AspNetUsers] ASN on asn.Id = AUA.UserId
       where 1=1  
...
";
        ...
        public UserProfile UserProfileActivate(UserProfile model)
        {
            try
            {
                string sqlText = "";
                ...
                string query = $@"UPDATE {AuthDbConfig.AuthDB}.[dbo].[AspNetUsers] SET 
