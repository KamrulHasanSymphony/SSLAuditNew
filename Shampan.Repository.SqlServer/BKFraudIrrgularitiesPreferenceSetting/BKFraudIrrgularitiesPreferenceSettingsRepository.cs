...
namespace Shampan.Repository.SqlServer.BKFraudIrrgularitiesPreferenceSetting
{
	public class BKFraudIrrgularitiesPreferenceSettingsRepository : Repository, IBKFraudIrrgularitiesPreferenceSettingRepository
    {
        private DbConfig _dbConfig;
        private SqlConnection context;
        private SqlTransaction transaction;       
        public BKFraudIrrgularitiesPreferenceSettingsRepository(SqlConnection context, SqlTransaction transaction, DbConfig dbConfig)
        ...
        public BKFraudIrregularitiesInternalControlPreferenceCBS FraudIrrgularitiesPreferenceTempInsert(BKFraudIrregularitiesInternalControlPreferenceCBS model)
        {
            try
            {
                string sqlText = "";

                var command = CreateCommand(@" INSERT INTO BKFraudIrregularitiesInternalControlPreferenceCBSTemp(
...
,@Status
        ...
        public List<BKFraudIrrgularitiesPreferenceSettings> GetAll(string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
		{
            try
            {
...
FROM  BKFraudIrrgularitiesPreferenceSettings
...
where 1=1";
                ...
                List<BKFraudIrrgularitiesPreferenceSettings> vms = dtResult.ToList<BKFraudIrrgularitiesPreferenceSettings>();
                return vms;
		...
		{
            string sqlText = "";
            List<BKFraudIrrgularitiesPreferenceSettings> VMs = new List<BKFraudIrrgularitiesPreferenceSettings>();
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                select count(BKFraudIrrgularitiesPreferenceSettings.Id)FilteredCount
                from BKFraudIrrgularitiesPreferenceSettings  where 1=1 ";
        ...
        public List<BKFraudIrrgularitiesPreferenceSettings> GetIndexData(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
		{
            string sqlText = "";
            List<BKFraudIrrgularitiesPreferenceSettings> VMs = new List<BKFraudIrrgularitiesPreferenceSettings>();
            DataTable dt = new DataTable();
...
";
                ...
                objComm.Fill(dt);
                var req = new BKFraudIrrgularitiesPreferenceSettings();

                VMs.Add(req);


                VMs = dt.ToList<BKFraudIrrgularitiesPreferenceSettings>();
        ...
        public List<BKFraudIrrgularitiesPreferenceSettings> GetIndexDataTemp(IndexModel index, string[] conditionalFields, string[] conditionalValue, PeramModel vm = null)
        {
            string sqlText = "";
            List<BKFraudIrrgularitiesPreferenceSettings> VMs = new List<BKFraudIrrgularitiesPreferenceSettings>();
            DataTable dt = new DataTable();
...
FROM BKFraudIrregularitiesInternalControlPreferenceCBSTemp 
where 1=1 
...
";
		...
		public BKFraudIrrgularitiesPreferenceSettings Insert(BKFraudIrrgularitiesPreferenceSettings model)
		{
			try
			{
				string sqlText = "";

				var command = CreateCommand(@" INSERT INTO BKFraudIrrgularitiesPreferenceSettings(
...
,@CreatedFrom
				...
				command.Parameters.Add("@PreviouslyFraudIncidentFlag", SqlDbType.Bit).Value = model.PreviouslyFraudIncidentFlag;
				command.Parameters.Add("@EmpMisConductFlag", SqlDbType.Bit).Value = model.EmpMisConductFlag;
				command.Parameters.Add("@Status", SqlDbType.Bit).Value = model.Status;
                command.Parameters.Add("@AuditYear", SqlDbType.DateTime).Value = model.AuditYear;
        ...
        public BKFraudIrrgularitiesPreferenceSettings MultiplePost(BKFraudIrrgularitiesPreferenceSettings objBKFraudIrrgularitiesPreferenceSettings)
        {
            try
            {
                string sqlText = "";
                ...
                string query = @"  update BKFraudIrrgularitiesPreferenceSettingss set 
    ...
    ,IsRejected=@IsRejected 
     ...
     where  Id= @Id ";
                ...
                return objBKFraudIrrgularitiesPreferenceSettings;
		...
		public BKFraudIrrgularitiesPreferenceSettings MultipleUnPost(BKFraudIrrgularitiesPreferenceSettings vm)
		{

            return new BKFraudIrrgularitiesPreferenceSettings();
		
		}

		public BKFraudIrrgularitiesPreferenceSettings Update(BKFraudIrrgularitiesPreferenceSettings model)
		{
			try
			{
				string sqlText = "";
				...
				string query = @"  update BKFraudIrrgularitiesPreferenceSettings set


 BKAuditOfficeTypeId               =@BKAuditOfficeTypeId  
,BKAuditOfficeId                   =@BKAuditOfficeId  
,PreviouslyFraudIncidentFlag       =@PreviouslyFraudIncidentFlag  
,EmpMisConductFlag                 =@EmpMisConductFlag  
,Status                            =@Status  
,AuditYear                                        =@AuditYear  
