...
namespace SSLAudit.Controllers
{
	...
	[Authorize]
	public class BKAuditInfoMasterController : Controller
    {
        ...
        private readonly IBKAuditInfoMasterService _bkAuditInfoMasterService;

        public BKAuditInfoMasterController(

	    ApplicationDbContext applicationDb,
		ITeamsService teamsService,
		IAdvancesService advancesService, 
		IBKCheckListTypeService BKCheckListTypeService,
        IBKAuditInfoMasterService bkAuditInfoMasterService
            ...
            )
        {
            ...
            _bkAuditInfoMasterService = bkAuditInfoMasterService;
        }
		...
		public IActionResult _index()
		{
			try
			{
                ...
                ResultModel<List<BKAuditInfoMaster>> indexData =
                    _bkAuditInfoMasterService.GetIndexData(index, conditionalFields, conditionalValue);

				ResultModel<int> indexDataCount =
                _bkAuditInfoMasterService.GetIndexDataCount(index, conditionalFields, conditionalValue);

				int result = _bkAuditInfoMasterService.GetCount(TableName.BKAuditInfoMaster, "Id", new[] { "BKRiskAssessPerferenceSettings.createdBy", }, new[] { userName });
        ...
        public ActionResult Create()
        {
            ...
            ModelState.Clear();
            BKAuditInfoMaster vm = new BKAuditInfoMaster();
            vm.Operation = "add";
            return View("CreateEdit", vm);


        }
        public ActionResult CreateEdit(BKAuditInfoMaster master)
        {
            ResultModel<BKAuditInfoMaster> result = new ResultModel<BKAuditInfoMaster>();
            try
            {
                ...
                if (master.Operation == "update")
                {
                    ...
                    result = _bkAuditInfoMasterService.Update(master);
                ...
                else
                {
                    ...
                    result = _bkAuditInfoMasterService.Insert(master);
		...
		public ActionResult Edit(int id)
		{
			try
            {
                ResultModel<List<BKAuditInfoMaster>> result =
                    _bkAuditInfoMasterService.GetAll(new[] { "Id" }, new[] { id.ToString() });

                BKAuditInfoMaster BKRiskAssessPerferenceSetting = result.Data.FirstOrDefault();
