...
namespace SSLAudit.Controllers
{
	...
	[Authorize]
	public class BKCheckListTypeController : Controller
    {
        ...
        public BKCheckListTypeController(ApplicationDbContext applicationDb, ITeamsService teamsService,
		...
		public IActionResult _index()
		{
			try
			{
                ...
                ResultModel<List<BKCheckListType>> indexData =
                    _BKCheckListTypeService.GetIndexData(index, conditionalFields, conditionalValue);

				ResultModel<int> indexDataCount =
                _BKCheckListTypeService.GetIndexDataCount(index, conditionalFields, conditionalValue);

				int result = _BKCheckListTypeService.GetCount(TableName.BKCheckListTypes, "Id", new[] { "BKCheckListTypes.createdBy", }, new[] { userName });
        ...
        public ActionResult Create()
        {
            ...
            ModelState.Clear();
            BKCheckListType vm = new BKCheckListType();
            vm.Operation = "add";
            return View("CreateEdit", vm);


        }
        public ActionResult CreateEdit(BKCheckListType master)
        {
            ResultModel<BKCheckListType> result = new ResultModel<BKCheckListType>();
            try
            {
                ...
                if (master.Operation == "update")
                {
                    ...
                    result = _BKCheckListTypeService.Update(master);
                ...
                else
                {
                    ...
                    result = _BKCheckListTypeService.Insert(master);
		...
		public ActionResult Edit(int id)
		{
			try
            {
                ResultModel<List<BKCheckListType>> result =
                    _BKCheckListTypeService.GetAll(new[] { "Id" }, new[] { id.ToString() });

                BKCheckListType BKCheckListType = result.Data.FirstOrDefault();
                BKCheckListType.Operation = "update";
                BKCheckListType.Id = id;

                return View("CreateEdit", BKCheckListType);
            }
            catch (Exception e)
            {
                e.LogAsync(ControllerContext.HttpContext);
