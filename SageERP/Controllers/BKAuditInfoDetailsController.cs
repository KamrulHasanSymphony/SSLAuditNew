...
namespace SSLAudit.Controllers
{
	...
	[Authorize]
	public class BKAuditInfoDetailsController : Controller
    {
        ...
        private readonly IBKAuditInfoDetailsService _bkAuditInfoDetailsService;

        public BKAuditInfoDetailsController(

	    ApplicationDbContext applicationDb,
		ITeamsService teamsService,
		IAdvancesService advancesService, 
		IBKCheckListTypeService BKCheckListTypeService,
        IBKAuditInfoDetailsService bkAuditInfoDetailsService
            ...
            )
        {
            ...
            _bkAuditInfoDetailsService = bkAuditInfoDetailsService;
        }
		...
		public IActionResult _index()
		{
			try
			{
                ...
                ResultModel<List<BKAuditInfoDetails>> indexData =
                    _bkAuditInfoDetailsService.GetIndexData(index, conditionalFields, conditionalValue);

				ResultModel<int> indexDataCount =
                _bkAuditInfoDetailsService.GetIndexDataCount(index, conditionalFields, conditionalValue);

				int result = _bkAuditInfoDetailsService.GetCount(TableName.BKAuditInfoMaster, "Id", new[] { "BKRiskAssessPerferenceSettings.createdBy", }, new[] { userName });
        ...
        public ActionResult Create()
        {
            ...
            ModelState.Clear();
            BKAuditInfoDetails vm = new BKAuditInfoDetails();
            vm.Operation = "add";
            return View("CreateEdit", vm);


        }
        public ActionResult CreateEdit(BKAuditInfoDetails master)
        {
            ResultModel<BKAuditInfoDetails> result = new ResultModel<BKAuditInfoDetails>();
            try
            {
                ...
                if (master.Operation == "update")
                {
                    ...
                    result = _bkAuditInfoDetailsService.Update(master);
                ...
                else
                {
                    ...
                    result = _bkAuditInfoDetailsService.Insert(master);
		...
		public ActionResult Edit(int id)
		{
			try
            {
                ResultModel<List<BKAuditInfoDetails>> result =
                    _bkAuditInfoDetailsService.GetAll(new[] { "Id" }, new[] { id.ToString() });

                BKAuditInfoDetails BKAuditInfoDetails = result.Data.FirstOrDefault();
                BKAuditInfoDetails.Operation = "update";
                BKAuditInfoDetails.Id = id;

                return View("CreateEdit", BKAuditInfoDetails);
            }
            catch (Exception e)
            {
                e.LogAsync(ControllerContext.HttpContext);
