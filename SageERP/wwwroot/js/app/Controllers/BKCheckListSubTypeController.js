var BKCheckListSubTypeController = function (CommonService, BKCheckListSubTypeService) {
    ...
    var init = function () {
        ...
        var indexTable = BKCheckListSubTypeTable();
    ...
    function save() {
        ...
        var validator = $("#frm_BKCheckListSubType").validate();
        var BKCheckListSubType = serializeInputs("frm_BKCheckListSubType");
        var result = validator.form();

        var isChecked = $("#Status").is(":checked");
        BKCheckListSubType.Status = isChecked;
        ...
        BKCheckListSubTypeService.save(BKCheckListSubType, saveDone, saveFail);
    ...
    var BKCheckListSubTypeTable = function () {

        $('#BKCheckListSubTypeList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#BKCheckListSubTypeList thead');


        var dataTable = $("#BKCheckListSubTypeList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/BKCheckListSubType/Edit/" + data + " class='edit btn btn-primary btn-sm' ><i class='fas fa-pencil-alt' data-toggle='tooltip' title='' data-original-title='Edit'></i></a> " //+
        ...
        $("#BKCheckListSubTypeList").on("change",
            ".acc-filters",
            function () {
        ...
        $("#BKCheckListSubTypeList").on("keyup",
            ".acc-filters",
            function () {
...
}(CommonService, BKCheckListSubTypeService);