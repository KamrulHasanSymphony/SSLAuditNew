    ...
    function saveDone(result) {
        ...
        if (result.status == "200") {
            ...
            if (result.data.operation == "add") {
                ...
                $("#BKAuditPreferenceEvaluation_BranchCode").val(result.data.branchID);

                $("#BKAuditPreferenceEvaluation_BranchID").val(result.data.branchID);
                $("#BKAuditOfficesPreferenceInfo_BranchID").val(result.data.branchID);
                $("#BKCommonSelectionSetting_BranchID").val(result.data.branchID);
                $("#BKFinancePerformPreferenceSetting_BranchID").val(result.data.branchID);
                $("#BKFraudIrrgularitiesPreferenceSetting_BranchID").val(result.data.branchID);
                $("#BKInternalControlWeakPreferenceSetting_BranchID").val(result.data.branchID);
                $("#BKReguCompliancesPreferenceSetting_BranchID").val(result.data.branchID);
                $("#BKRiskAssessPerferenceSetting_BranchID").val(result.data.branchID);
