var AdvanceSelfApproveStatusController = function (CommonService, AdvancesService, AdvanceSelfApproveStatusService) {
    ...
    var AdvanceApproveStatusTable = function () {
        ...
        var dataTable = $("#ApproveStatusist").DataTable({
            ...
            ajax: {
                ...
                url: '/Advances/_approveStatusIndex?status=' + Status,
                type: 'POST',
...
}(CommonService, AdvancesService, AdvanceSelfApproveStatusService);