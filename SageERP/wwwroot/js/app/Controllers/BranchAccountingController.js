var BranchAccountingController = function (CommonService, ToursService) {
    ...
    var ToursTable = function () {
        ...
        $('#SaleList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#SaleList thead');


        var dataTable = $("#SaleList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
...
}(CommonService, BranchAccountingService);