var BKAuditInfoMasterApprovalController = function (CommonService, BKAuditInfoMasterApprovalService) {
    ...
    var init = function () {
        ...
        var indexTable = BKAuditInfoMasterApprovalTable();
    ...
    function save() {
        ...
        var validator = $("#frm_BKAuditInfoMasterApproval").validate();
        var BKAuditInfoMasterApproval = serializeInputs("frm_BKAuditInfoMasterApproval");
        var result = validator.form();

        var isChecked = $("#Status").is(":checked");
        BKAuditInfoMasterApproval.Status = isChecked;

        var AuditApprovalFlag = $("#AuditApprovalFlag").is(":checked");
        BKAuditInfoMasterApproval.AuditApprovalFlag = AuditApprovalFlag;
        ...
        BKAuditInfoMasterApprovalService.save(BKAuditInfoMasterApproval, saveDone, saveFail);
    ...
    var BKAuditInfoMasterApprovalTable = function () {

        $('#BKAuditInfoMasterApprovalList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#BKAuditInfoMasterApprovalList thead');


        var dataTable = $("#BKAuditInfoMasterApprovalList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            ajax: {
                url: '/BKAuditInfoMasterApproval/_index',
                type: 'POST',
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/BKAuditInfoMasterApproval/Edit/" + data + " class='edit btn btn-primary btn-sm' ><i class='fas fa-pencil-alt' data-toggle='tooltip' title='' data-original-title='Edit'></i></a> "                                                 
                            ;                
                    },
                    "width": "9%",
                    "orderable": false
                ...
                ,
                {
                    data: "auditApprovalFlag",
                    name: "AuditApprovalFlag"
                }
                ,
                {
                    data: "status",
        ...
        $("#BKAuditInfoMasterApprovalList").on("change",
            ".acc-filters",
            function () {
        ...
        $("#BKAuditInfoMasterApprovalList").on("keyup",
            ".acc-filters",
            function () {
...
}(CommonService, BKAuditInfoMasterApprovalService);