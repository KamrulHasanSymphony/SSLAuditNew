var AuditIssueController = function (AuditIssueService) {
    ...
    $("#download").on("click", function () {
        ...
        var fromDate = $("#FromDate").val();
        var toDate = $("#ToDate").val();
        var Compliance = $("#Compliance").prop('checked');
        var Financial = $("#Financial").prop('checked');
        var Operational = $("#Operational").prop('checked');
        var InvestigationOrForensis = $("#InvestigationOrForensis").prop('checked');
        var StratigicMeeting = $("#StratigicMeeting").prop('checked');
        var ManagementReviewMeeting = $("#ManagementReviewMeeting").prop('checked');
        var OtherMeeting = $("#OtherMeeting").prop('checked');
        var Training = $("#Training").prop('checked');
        ...
        var url = '/AuditIssue/IssueExcel?fromDate=' +
            fromDate +
            '&toDate=' +
            toDate +
            '&Compliance=' +
            ...
            columns: [

                {
                    ...
                    render: function (data, type, row) {
                        ...
                        else if (edit === "PendingForReviewerFeedback" || edit === "PendingForReviewerFeedbackForTeam") {
    ...
    var excelIndexListTableData = function () {
        ...
        var dataTable = $("#ExcelIndexList").DataTable({
            ...
            bRetrieve: true,
            searching: false,
            lengthMenu: [10, 25, 50, 100, 125, 150, 175, 200, 300, 400, 500,1000,1500,2000],
