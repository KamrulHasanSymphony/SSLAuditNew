var BKAuditOfficeTypeController = function (CommonService, BKAuditOfficeTypeService) {
    ...
    var init = function () {
        ...
        var indexTable = BKAuditOfficeTypeTable();
    ...
    function save() {
        ...
        var validator = $("#frm_BKAuditOfficeType").validate();
        var BKAuditOfficeType = serializeInputs("frm_BKAuditOfficeType");
        var result = validator.form();
      
        var isChecked = $("#Status").is(":checked");
        BKAuditOfficeType.Status = isChecked;
        ...
        BKAuditOfficeTypeService.save(BKAuditOfficeType, saveDone, saveFail);
    ...
    var BKAuditOfficeTypeTable = function () {

        $('#BKAuditOfficeTypeList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#BKAuditOfficeTypeList thead');


        var dataTable = $("#BKAuditOfficeTypeList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/BKAuditOfficeType/Edit/" + data + " class='edit btn btn-primary btn-sm' ><i class='fas fa-pencil-alt' data-toggle='tooltip' title='' data-original-title='Edit'></i></a> " //+
...
}(CommonService, BKAuditOfficeTypeService);