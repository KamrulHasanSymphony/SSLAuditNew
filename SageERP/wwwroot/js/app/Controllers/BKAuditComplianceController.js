var BKAuditComplianceController = function (CommonService, BKAuditComplianceService) {
    ...
    var init = function () {
        ...
        if ($("#BKAuidtCategoryId").length) {
            LoadCombo("BKAuidtCategoryId", '/Common/BKAuidtCategorys');
        }
        if ($("#Severity").length) {
            LoadCombo("Severity", '/Common/GetIssuePriority');
        }
        if ($("#BKAuditOfficeTypesId").length) {
            LoadCombo("BKAuditOfficeTypesId", '/Common/BKAuditOfficeTypes');
        }
        ...
        var indexTable = BKAuditComplianceTable();
    ...
    function save() {
        ...
        var validator = $("#frm_BKAuditCompliance").validate();
        var BKAuditCompliance = serializeInputs("frm_BKAuditCompliance");
        ...
        BKAuditComplianceService.save(BKAuditCompliance, saveDone, saveFail);
    ...
    var BKAuditComplianceTable = function () {

        $('#BKAuditComplianceList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#BKAuditComplianceList thead');


        var dataTable = $("#BKAuditComplianceList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/BKAuditCompliance/Edit/" + data + " class='edit btn btn-primary btn-sm' ><i class='fas fa-pencil-alt' data-toggle='tooltip' title='' data-original-title='Edit'></i></a> " //+
        ...
        $("#BKAuditComplianceList").on("change",
            ".acc-filters",
            function () {
        ...
        $("#BKAuditComplianceList").on("keyup",
            ".acc-filters",
            function () {
...
}(CommonService, BKAuditComplianceService);