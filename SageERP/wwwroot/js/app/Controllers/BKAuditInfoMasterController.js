var BKAuditInfoMasterController = function (CommonService, BKAuditInfoMasterService) {
    ...
    var init = function () {
        ...
        var indexTable = BKAuditInfoMasterTable();
    ...
    var BKAuditInfoMasterTable = function () {

        $('#BKAuditInfoMasterList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#BKAuditInfoMasterList thead');


        var dataTable = $("#BKAuditInfoMasterList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
        ...
        $("#BKAuditInfoMasterList").on("change",
            ".acc-filters",
            function () {
        ...
        $("#BKAuditInfoMasterList").on("keyup",
            ".acc-filters",
            function () {
...
}(CommonService, BKAuditInfoMasterService);