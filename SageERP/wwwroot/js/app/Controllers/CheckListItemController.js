var CheckListItemController = function (CommonService, AdvancesService) {
    ...
    var init = function () {
        ...
        if ($("#BkCheckListTypesId").length) {
            LoadCombo("BkCheckListTypesId", '/Common/BkCheckListTypes');
        }

        if ($("#BKCheckListSubTypesId").length) {
            LoadCombo("BKCheckListSubTypesId", '/Common/BkCheckListSubTypes');
        }

        if ($("#FieldType").length) {
            //LoadCombo("FieldType", '/Common/FieldType');
        }
        ...
        var indexTable = CheckListItemTable();
    ...
    function save() {
        ...
        var validator = $("#frm_CheckListItem").validate();
        var checkListItem = serializeInputs("frm_CheckListItem");
        var result = validator.form();

        var isChecked = $("#IsFieldType").is(":checked");
        checkListItem.IsFieldType = isChecked;
        isChecked = $("#Status").is(":checked");
        checkListItem.Status = isChecked;
        ...
        CheckListItemService.save(checkListItem, saveDone, saveFail);
    ...
    var CheckListItemTable = function () {

        $('#CheckListItemList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#CheckListItemList thead');


        var dataTable = $("#CheckListItemList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/BKCheckListItem/Edit/" + data + " class='edit btn btn-primary btn-sm' ><i class='fas fa-pencil-alt' data-toggle='tooltip' title='' data-original-title='Edit'></i></a> " //+
...
}(CommonService, CheckListItemService);