var BKCheckListTypeController = function (CommonService, BKCheckListTypeService) {



    var init = function () {
        
        if ($("#BkAuditCompliancesId").length) {
            LoadCombo("BkAuditCompliancesId", '/Common/BkAuditCompliances');
        }
        ...
        var indexTable = BKCheckListTypeTable();
    ...
    function save() {
        ...
        var validator = $("#frm_BKCheckListType").validate();
        var BKCheckListType = serializeInputs("frm_BKCheckListType");
        var result = validator.form();

        var isChecked = $("#Status").is(":checked");
        BKCheckListType.Status = isChecked;
        ...
        BKCheckListTypeService.save(BKCheckListType, saveDone, saveFail);
    ...
    var BKCheckListTypeTable = function () {

        $('#BKCheckListTypeList thead tr')
            .clone(true)
            .addClass('filters')
            .appendTo('#BKCheckListTypeList thead');


        var dataTable = $("#BKCheckListTypeList").DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            serverSide: true,
            "processing": true,
            ...
            columns: [

                {
                    ...
                    render: function (data) {
                        ...
                        return "<a href=/BKCheckListType/Edit/" + data + " class='edit btn btn-primary btn-sm' ><i class='fas fa-pencil-alt' data-toggle='tooltip' title='' data-original-title='Edit'></i></a> " //+
...
}(CommonService, BKCheckListTypeService);