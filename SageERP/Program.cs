...
//API
HttpRequestHelper.Initialize(builder.Configuration);
builder.Services.AddSingleton<HttpRequestHelper>();
HttpRequestHelperHRM.Initialize(builder.Configuration);
builder.Services.AddSingleton<HttpRequestHelperHRM>();
HttpRequestHelperVAT.Initialize(builder.Configuration);
builder.Services.AddSingleton<HttpRequestHelperVAT>();
HttpRequestHelperCBS.Initialize(builder.Configuration);
builder.Services.AddSingleton<HttpRequestHelperCBS>();
//END
